  ...
  const principles = [
    {
      ...
      description: "Every decision starts with the user in mind. Intuitive design that feels natural.",
      align: "left",
    },
    {
      number: "02",
      ...
      description: "We don't rush. Perfection through iteration and user feedback.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        ...
        { text: " ESSENTIAL", highlight: false },
      ],
      description: "Games and apps should bring joy. Entertainment with purpose.",
      align: "left",
    },
    {
      number: "04",
      ...
      description: "Constantly exploring new ideas to create better experiences.",
      align: "right",
    },
  ]
