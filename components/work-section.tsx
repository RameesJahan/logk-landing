...
const experiments = [
  {
    ...
    medium: "Mobile Game",
    description:
      "A fun game you can play with friends and family. Available on Google Play Store.",
  ...
  },
  {
    ...
    description:
      "A timer using the Pomodoro Technique for enhanced productivity and focus.",
    span: "col-span-2 row-span-2",
    icon: "/play-store.svg",
  },
];
    ...
    >
      ...
      <div ref={headerRef} className="mb-16 flex items-end justify-between">
        ...
        <p className="hidden md:block max-w-xs font-mono text-xs text-muted-foreground text-right leading-relaxed">
          Crafted experiences across gaming and productivity, designed for
...
function WorkCard({
  ...
  return (
    ...
    >
      ...
      {/* Play Store Icon */}
      {experiment.icon === "/play-store.svg" && (
        <span
          className={cn(
