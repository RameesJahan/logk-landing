...
const signals = [
  {
    date: "2025.02.07",
    title: "SOS Game Released",
    note: "A fun game you can play with friends and family. Now available on Google Play Store.",
  },
  {
    date: "2025.01.15",
    title: "Pomodoro Timer App",
    note: "Productivity timer using the proven Pomodoro Technique for better focus and efficiency.",
  },
]
